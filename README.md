...
* [Cities API:](https://github.com/Carla-de-Beer/Spring-Boot-Projects/tree/master/Cities%20API) A simple Spring Boot microservices project that registers a client application with a Eureka server.
* [Eureka Server Project:](https://github.com/Carla-de-Beer/Spring-Boot-Projects/tree/master/Eureka%20Server%20Project) A Spring Boot API project displaying city data, operating on a MySQL database.
