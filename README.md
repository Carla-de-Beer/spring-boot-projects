...
* [Eureka Server Project:](https://github.com/Carla-de-Beer/Spring-Boot-Projects/tree/master/Eureka%20Server%20Project) A simple Spring Boot microservices project that registers a client application with a Eureka server.
